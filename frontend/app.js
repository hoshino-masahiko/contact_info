...
const FIELD_GROUPS = [
  ...
  },
  {
    title: "緊急連絡先（1）",
    fields: [
      { key: "氏名(緊急連絡先1)", label: "氏名(緊急連絡先1)" },
      { key: "フリガナ(緊急連絡先1)", label: "フリガナ(緊急連絡先1)" },
      { key: "続柄(緊急連絡先1)", label: "続柄(緊急連絡先1)" },
      { key: "電話番号(緊急連絡先1)", label: "電話番号(緊急連絡先1)" },
      { key: "メールアドレス(緊急連絡先1)", label: "メールアドレス(緊急連絡先1)" },
    ],
  },
  {
    title: "緊急連絡先（2）",
    fields: [
      { key: "氏名(緊急連絡先2)", label: "氏名(緊急連絡先2)" },
      { key: "フリガナ(緊急連絡先2)", label: "フリガナ(緊急連絡先2)" },
      { key: "続柄(緊急連絡先2)", label: "続柄(緊急連絡先2)" },
      { key: "電話番号(緊急連絡先2)", label: "電話番号(緊急連絡先2)" },
      { key: "メールアドレス(緊急連絡先2)", label: "メールアドレス(緊急連絡先2)" },
    ],
  },
];
